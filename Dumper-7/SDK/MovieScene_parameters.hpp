...
// 0x0020 (0x0020 - 0x0000)
struct MovieSceneSequencePlayer_SetMarkerRange final
{
public:
	class FString                                 InStartLabel;                                      // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 InStopLabel;                                       // 0x0010(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_MovieSceneSequencePlayer_SetMarkerRange;
