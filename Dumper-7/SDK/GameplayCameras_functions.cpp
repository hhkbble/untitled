...
// Parameters:
// const struct FBlueprintCameraDirectorActivateParams&params                                                 (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)

void UBlueprintCameraDirectorEvaluator::ActivateCameraDirector(const struct FBlueprintCameraDirectorActivateParams& params)
{
...
// (Event, Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FBlueprintCameraDirectorDeactivateParams&params                                                 (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)

void UBlueprintCameraDirectorEvaluator::DeactivateCameraDirector(const struct FBlueprintCameraDirectorDeactivateParams& params)
{
	static class UFunction* Func = nullptr;
...
// (Event, Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FBlueprintCameraDirectorEvaluationParams&params                                                 (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)

void UBlueprintCameraDirectorEvaluator::RunCameraDirector(const struct FBlueprintCameraDirectorEvaluationParams& params)
{
	static class UFunction* Func = nullptr;
