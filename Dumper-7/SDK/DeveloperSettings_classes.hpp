...
// Class DeveloperSettings.DeveloperSettingsBackedByNexus
// 0x0008 (0x0040 - 0x0038)
class UDeveloperSettingsBackedByNexus : public UDeveloperSettings
{
public:
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("DeveloperSettingsBackedByNexus")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"DeveloperSettingsBackedByNexus")
	}
	static class UDeveloperSettingsBackedByNexus* GetDefaultObj()
	{
		return GetDefaultObjImpl<UDeveloperSettingsBackedByNexus>();
	}
};
DUMPER7_ASSERTS_UDeveloperSettingsBackedByNexus;
